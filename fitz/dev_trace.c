...
static void
fz_trace_fill_path(fz_context *ctx, void *user, fz_path *path, int even_odd, fz_matrix ctm,
...
static void
fz_trace_stroke_path(fz_context *ctx, void *user, fz_path *path, fz_stroke_state *stroke, fz_matrix ctm,
	fz_colorspace *colorspace, float *color, float alpha)
{
	int i;
...
static void
fz_trace_clip_path(fz_context *ctx, void *user, fz_path *path, fz_rect *rect, int even_odd, fz_matrix ctm)
{
	printf("<clip_path ");
	if (even_odd)
		printf("winding=\"eofill\" ");
...
static void
fz_trace_clip_stroke_path(fz_context *ctx, void *user, fz_path *path, fz_rect *rect, fz_stroke_state *stroke, fz_matrix ctm)
{
...
static void
fz_trace_fill_text(fz_context *ctx, void *user, fz_text *text, fz_matrix ctm,
	fz_colorspace *colorspace, float *color, float alpha)
{
...
static void
fz_trace_stroke_text(fz_context *ctx, void *user, fz_text *text, fz_stroke_state *stroke, fz_matrix ctm,
	fz_colorspace *colorspace, float *color, float alpha)
{
...
static void
fz_trace_clip_text(fz_context *ctx, void *user, fz_text *text, fz_matrix ctm, int accumulate)
{
...
static void
fz_trace_clip_stroke_text(fz_context *ctx, void *user, fz_text *text, fz_stroke_state *stroke, fz_matrix ctm)
{
...
static void
fz_trace_ignore_text(fz_context *ctx, void *user, fz_text *text, fz_matrix ctm)
{
...
static void
fz_trace_fill_image(fz_context *ctx, void *user, fz_pixmap *image, fz_matrix ctm, float alpha)
{
...
static void
fz_trace_fill_shade(fz_context *ctx, void *user, fz_shade *shade, fz_matrix ctm, float alpha)
{
...
static void
fz_trace_fill_image_mask(fz_context *ctx, void *user, fz_pixmap *image, fz_matrix ctm,
fz_colorspace *colorspace, float *color, float alpha)
{
...
static void
fz_trace_clip_image_mask(fz_context *ctx, void *user, fz_pixmap *image, fz_rect *rect, fz_matrix ctm)
{
...
static void
fz_trace_pop_clip(fz_context *ctx, void *user)
{
	printf("<pop_clip />\n");
}

static void
fz_trace_begin_mask(fz_context *ctx, void *user, fz_rect bbox, int luminosity, fz_colorspace *colorspace, float *color)
{
...
static void
fz_trace_end_mask(fz_context *ctx, void *user)
{
	printf("</mask>\n");
}

static void
fz_trace_begin_group(fz_context *ctx, void *user, fz_rect bbox, int isolated, int knockout, int blendmode, float alpha)
{
...
static void
fz_trace_end_group(fz_context *ctx, void *user)
{
	printf("</group>\n");
}

static void
fz_trace_begin_tile(fz_context *ctx, void *user, fz_rect area, fz_rect view, float xstep, float ystep, fz_matrix ctm)
{
	printf("<tile ");
...
static void
fz_trace_end_tile(fz_context *ctx, void *user)
{
	printf("</tile>\n");
}
