...
void xps_free_outline(fz_context *ctx, xps_outline *outline);
xps_named_dest *xps_parse_named_dests(xps_context *ctx);
void xps_free_named_dest(fz_context *ctx, xps_named_dest *dest);
void xps_extract_link_info(xps_context *ctx, xml_element *node, fz_rect rect, char *base_uri);
void xps_free_link(fz_context *ctx, xps_link *link);
